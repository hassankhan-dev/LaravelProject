...
@section('displayname')
<li><a href="#"><i class="fa fa-calendar"></i>{{$data}}</a></li>
@endsection
    ...
    <div class="container">
      ...
      <div class="row properties-box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
          <div class="item">
            <a href="{{route('detail')}}"><img src="assets/images/property-01.jpg" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$2.264.000</h6>
            <h4><a href="{{route('detail')}}">18 Old Street Miami, OR 97219</a></h4>
            <ul>
